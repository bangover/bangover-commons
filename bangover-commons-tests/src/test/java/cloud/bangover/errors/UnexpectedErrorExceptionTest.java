...
public class UnexpectedErrorExceptionTest {
  ...
  public UnexpectedErrorExceptionTest(UnexpectedErrorException wrappedError) {
    super();
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][] {
      {new UnexpectedErrorException(APPLICATION_ERROR)},
      {new UnexpectedErrorException(NON_APPLICATION_ERROR)}
    });
  }
  ...
  private static class SimpleApplicationException extends ApplicationException {
    ...
    public SimpleApplicationException() {
      super(ErrorSeverity.BUSINESS, ERROR_CODE);
    }
  }
}
